...
public class SponsorshipServiceTest extends AbstractTest {
	...
	/**
	 * a) #1 Test for Case use: Un administrador puede lanzar un proceso para cancelar los patrocinios de los patrocinadores que tengan la tarjeta de cr�dito caducada
	 * b)
	 * c) Sequence coverage: 100%
	 * d) Data coverage:
	 * 
