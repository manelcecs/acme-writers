...
<p>Fecha efectiva: February 19, 2019</p>


<p>Acme-Madrugá ("nosotros", "a nosotros", "nuestro") opera el sitio web www.acme.com (en adelante, el "Servicio").</p>
...
<p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros Términos y Condiciones, disponibles en el www.acme.com</p>

<h2>Definiciones</h2>
<ul>
    <li>
        <p><strong>Servicio</strong></p>
                <p>Servicio es el sitio web www.acme.com operado por Acme-Madrugá</p>
            </li>
    <li>
...
<ul>
    <li>Dirección de e-mail</li>    <li>Nombre y apellidos</li>    <li>Número de teléfono</li>    <li>Dirección, localidad, provincia, código postal, ciudad</li>    <li>Cookies y datos de uso</li>
</ul>
...
<h2>Uso de datos</h2> 
<p>Acme-Madrugá utiliza los datos recopilados con diversas finalidades:</p>    
<ul>
...
<ul>
        <li>Por e-mail: manpergut@alum.us.es</li>
